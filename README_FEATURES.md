...
├── domain/                      # 领域层 - 核心业务逻辑
│   ├── core/                   # 核心构建块
│   │   ├── Result.js          # 操作结果封装 (Success/Failure)
│   │   ├── Entity.js          # 实体基类 (唯一标识)
│   │   ├── UniqueEntityId.js  # 唯一ID值对象
│   │   └── Guard.js           # 输入验证守卫
│   └── entities/              # 领域实体
│       ├── User.js            # 用户实体
│       └── Project.js         # 项目实体
...
│   ├── ports/                 # 端口接口定义
│   │   ├── IAuthPort.js      # 认证端口
│   │   ├── IProjectPort.js   # 项目端口
│   │   └── ITaskPort.js      # 任务端口
│   └── use-cases/            # 用例实现
│       ├── LoginUseCase.js   # 登录用例
...
└── infrastructure/            # 基础设施层 - 外部依赖
    └── adapters/             # 适配器实现
        ...
        ├── SupabaseProjectAdapter.js
        └── SupabaseTaskAdapter.js
```
